...
const (
	...
	KeyBindingModeConflict   = "binding.mode_conflict"
	KeyDisplayKeyNotCategory = "category.display_key_not_category_field"
	KeyFieldNotForModel      = "import.field_not_for_model"
	...
	// 013 角色与权限
	KeyRoleNeedsName   = "role.needs_name"
	KeyRoleDuplicate   = "role.duplicate"
	KeyRoleAdminFixed  = "role.admin_fixed"
	KeyRoleInUse       = "role.in_use"
	KeyRoleUnknownPerm = "role.unknown_permission"
	KeyRoleLastAdmin   = "role.last_admin"
	KeyRoleSelfDemote  = "role.self_demote"
	KeyForbidden       = "err.forbidden"

	// The switch names, as the interface says them. A refusal reads
	// "你没有「管理类别与字段」权限", not "schema.manage".
	KeyPermAssetCreate    = "perm.asset_create"
	KeyPermAssetUpdate    = "perm.asset_update"
	KeyPermAssetDelete    = "perm.asset_delete"
	KeyPermTransferCreate = "perm.transfer_create"
	KeyPermTransferUpdate = "perm.transfer_update"
	KeyPermPrint          = "perm.print"
	KeyPermImport         = "perm.import"
	KeyPermExport         = "perm.export"
	KeyPermSchemaManage   = "perm.schema_manage"
	KeyPermModelManage    = "perm.model_manage"
	KeyPermStatusManage   = "perm.status_manage"
	KeyPermHolderCreate   = "perm.holder_create"
	KeyPermHolderUpdate   = "perm.holder_update"
	KeyPermHolderDelete   = "perm.holder_delete"
