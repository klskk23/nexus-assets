...
/**
 * The hairline between two kinds of action. The device menu uses two of them,
 * and the second one is load-bearing: 删除 sits alone below it so that it is
 * never the item immediately under the one the reader was aiming for.
 *
...
/** Reading, then doing, then destroying -- the device menu's three groups. */
...
/** The shortest menu that still earns one: the rule is 删除 stands apart. */
