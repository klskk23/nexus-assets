...
export const enMeta: typeof zhMeta = {
  ...
  fieldGroups: {
    ...
    bindTitle: (name: string) => `Bind ${name} to`,
    bindAction: "Bind to…",
    bindTarget: "Target",
    bindToCategory: "Category",
    bindToModel: "Model",
    bindToVendor: "Vendor",
    bindPick: "Pick one",
    bindConfirm: "Bind",
    ...
    bindDone: (name: string, target: string) => `${name} is now bound to ${target}`,
    bindNoTarget: "Nothing to bind to yet",
