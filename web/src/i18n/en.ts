...
export const en: typeof zh = {
  ...
  assets: {
    ...
    modelFilter: "Model",
    modelColumnLocked: "Pick a model first: this column belongs only to that model's devices",
    holderFilter: "Holder",
    sn: "Number",
    category: "Category",
    statusLabel: "Status",
...
export const enMeta: typeof zhMeta = {
  fields: {
    ...
    bindGroup: "Bind a field group",
    bindGroupHint: "Each member is bound separately; editing the group afterwards does not follow",
    noGroup: "No field group",
