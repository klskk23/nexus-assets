...
export const en: typeof zh = {
  ...
  perm: {
    ...
    names: {
      ...
      "audit.read": "View the operations log",
      "transfer.audit": "View the movement log",
...
export const enMeta: typeof zhMeta = {
  fields: {
    ...
    bindByDevice: "Devices",
    bindOnCreateVendor: "Bind to vendors",
    bindOnCreateVendorHint: "Every model from that vendor gets it, including ones added later",
    providedByVendor: (name: string) => `${name} already provides this field`,
    uniqueInDevices: "Unique across devices",
    vendorFilter: "Vendor",
    allVendors: "All vendors",
  ...
  vendors: {
    ...
    deleteHint: (name: string) =>
      `${name} will be removed. Refused while models still come from it -- move those to another vendor first.`,
    empty: "No vendors yet",
    emptyHint: "A vendor is a thing: rename it once, bind fields to it, and every model it makes inherits them.",
    none: "No vendor",
    changeTitle: "Changing the vendor makes some fields read-only",
    changeHint: (n: number, fields: string) =>
      `${fields} will no longer be provided by the vendor on ${n} device(s). The values stay visible but cannot be edited.`,
  },
  fieldGroups: {
    searchHint: "Name",
    title: "Field groups",
    ...
    deleteHint: (name: string) =>
      `${name} will be removed. Nothing it bound gets unbound -- a group is a shortcut at bind time and leaves no trace.`,
    empty: "No field groups yet",
    emptyHint: "Collect the fields that go together, then bind them in one act. A group changes nothing about the fields themselves.",
    bindFromEditor: "Ticking binds. A bound group leaves no trace, so this does not show where it already is, and unticking does not unbind.",
    bindHint: "Each member is bound separately, exactly as binding them one by one would. If any of them cannot be bound, none of them is.",
  ...
  panes: {
    ...
    kindVendor: "Vendor",
    inGroups: "In groups",
    noGroups: "In no group",
    groupMembers: "Fields in this group",
    modelFields: "This model\u2019s fields",
    vendorFields: "Bound to every model of this vendor",
    fromVendor: "Vendor",
    fromModel: "This model",
    devicesOn: (n: number) => `${n} on the books`,
